...
class AnkiQt(QMainWindow):
    ...
    def showProfileManager(self):
        ...
        d.rejected.connect(lambda: d.close())
...
title="%s">%s</button>''' % (
    ...
    def setupMenus(self):
        m = self.form
        #m.actionDownloadSharedPlugin.triggered.connect(self.onGetSharedPlugin)
        m.actionSwitchProfile.triggered.connect(self.unloadProfile)
...
will be lost. Continue?"""))
    ...
    def onCheckMediaDB(self):
        ...
        b.clicked.connect(lambda u=unused, d=diag: self.deleteUnused(u, d))
